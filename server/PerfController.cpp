...
{
    const char *rps_prop_default_name = "net.perf.rps.default";
    char rps_prop_default_value[16] = {0};
...
{
    const char *rps_prop_name  = "net.perf.tether.rps";
    const char *core_prop_name = "net.perf.tether.cpu.core";
    const char *freq_prop_name = "net.perf.tether.cpu.freq";
...
int PerfController::enter_little_cpu() {
    ...
    const char *internal_core_prop_name = "net.perf.internal.cpu.core";
    const char *internal_freq_prop_name = "net.perf.internal.cpu.freq";
    char internal_core_prop_value[100] = {0};
    char internal_freq_prop_value[100] = {0};
    int i, cluster;
